...
$.getJSON('/articles', function(data) {
  ...
  for (var i = 0; i<data.length; i++){
    ...
    $('#articles').append('<div class="col m12 m6">' + '<div class="card blue-grey darken-1">'  + data[i].title + '<br />'+ data[i].link + '</br>' + '<button type="submit" data-target="modal1" class="waves-effect waves-light btn teal lighten-1" data-id="' + data[i]._id + '">' + 'Add Comment' + '</button>' +'</div>' + '</div>');
  }
});
